...
class Account:
  ...
  def deposit(self, amount: float):
    ...
    self.__transactions.append(self.__getTransactionFormated("Deposit", amount))

  def withdraw(self, amount: float):
    if amount > self.__balance:
      raise ValueError(f'Not enough balance: Balance = {self.__balance}; Amount = {amount}')
    self.__balance -= amount;
    self.__transactions.append(self.__getTransactionFormated("Withdraw", amount))
